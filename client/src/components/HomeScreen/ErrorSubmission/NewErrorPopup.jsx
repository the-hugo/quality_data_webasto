...
const errorOptions = ['Dimension & Fit', 'Material & Documentation', 'Seal and Adhesion', 'Surface Quality']; // The array is outsourced
      ...
      <div className="popup-content">
        ...
        <div className="dropdown-container">
          <select
            ...
            onChange={(e) => handleOptionChange(e.target.value)} // Handle option change
        ...
        <div className="button-container">
          ...
          <button className="anomaly-button" onClick={handleAnomalyClick}>
            Anomaly
          </button>
          <button className="rework-button" onClick={handleReworkClick}>
            Rework
          </button>
          <button className="scrap-button" onClick={handleScrapClick}>
            Scrap
          </button>
        </div>
      </div>
